...
namespace _03.CarConstructors
{
    public class Car
    {
        ...
        public Car(string make, string model, int year, double fuelQuantity, double fuelConsuption,Engine engine, Tire[] tires) : this(make, model, year,fuelQuantity,fuelConsuption)
        {
           Engine= engine;
           Tires=tires;
        }
